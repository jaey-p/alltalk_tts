...
def orpheus_model_alltalk_settings(model_config_data, engine_instance):
...
def orpheus_at_gradio_settings_page(model_config_data, engine_instance):
    """Main function to set up the Orpheus Gradio settings page."""
    # Pass the engine instance to the settings layout function
    app = orpheus_model_alltalk_settings(model_config_data, engine_instance)
    return app